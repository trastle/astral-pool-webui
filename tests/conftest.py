...
def _isolate_mqtt_bridge_cache_file(monkeypatch, tmp_path):
    ...
    reading to LAST_KNOWN_GOOD_CACHE_FILE. Point every test at a throwaway path by
    ...
    monkeypatch.setattr("mqtt_bridge.LAST_KNOWN_GOOD_CACHE_FILE", tmp_path / "last_known_good_readings.json")
